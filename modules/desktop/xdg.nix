...
in {
  home-manager.users.${username} = {
    ...
    xdg = {
      ...
      cacheHome = "${config.home-manager.users.${username}.home.homeDirectory}/.cache";
      configHome = "${config.home-manager.users.${username}.home.homeDirectory}/.config";
      dataHome = "${config.home-manager.users.${username}.home.homeDirectory}/.local/share";
      stateHome = "${config.home-manager.users.${username}.home.homeDirectory}/.local/state";
