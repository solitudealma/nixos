...
# Wallpapers Path
wallpaperDir="$HOME/walls"
themesDir="$HOME/.config/rofi/applets"
...
# Rofi command
rofiCommand="rofi -show -dmenu -theme ${themesDir}/wallSelect.rasi"
...
# Execution
main() {
  choice=$(menu | ${rofiCommand} -p "Choose 󰋩 :")
