# https://github.com/NixOS/nixpkgs/issues/226867#issuecomment-1913102626

{ gdk-pixbuf, xdg-utils, cairo, fetchurl, fontconfig, freetype, glib, gtk3, lib
, libGL, libpulseaudio, libXext, libXi, libxkbcommon, libXmu, libXrender
, makeWrapper, pixman, stdenv, systemd, which, xorg, zlib, }:
let
